            ...
            <div className="mt-10 grid gap-10 md:grid-cols-5">
              ...
              <section className="md:col-span-3 space-y-4">
                <p className="text-[12px] leading-7 text-zinc-800">
                  ...
                  있는 데이터 생산 과정이라는 점에서 큰 책임감과 흥미를 느낄수
                  있었고. 이를 계기로 환경 측정과 분석 분야에 더욱 관심을 갖게
                  되었습니다. 학부 시절에는 춘천 대기권 환경생태조사 연구에
            ...
            <div className="mt-10 grid gap-10 md:grid-cols-5">
              ...
              <section className="md:col-span-3 space-y-4">
                <p className="text-[12px] leading-7 text-zinc-800">
                  ...
                  기업에서 근무하며 환경질 측정팀 소속으로 활동했습니다.
                  현장에서 대기·수질 시료를 채취하고, 실험실에서 분석을 수행해
                  법적 기준 적합 여부를 판단하는 업무를 담당했습니다. 현장
                  상황에 따라 채취 조건이 달라질 수 있었기에, 관련 기준을
                  숙지하고 정확한 절차에 따라 시료를 확보하는 데 특히 주의를
                  기울였습니다. 시료의 보관, 전처리, 기기 분석, 결과 기록 및
                  보고서 작성까지 전 과정을 직접 수행하며 분석 업무의 책임성과
                  정확성을 체득했습니다. 특히 기기 분석 시 발생할 수 있는 오차
                  요인을 사전에 점검하고, 반복 측정과 교차 검증을 통해 데이터의
                  신뢰도를 높이는 데 집중했습니다. 그 결과 재분석 요청을
                  최소화하며 안정적인 보고 체계를 유지할 수 있었습니다. 또한
                  분석 결과를 단순히 수치로 정리하는 데 그치지 않고, 데이터의
                  변동 원인과 현장 조건을 함께 검토하며 종합적으로 해석하려
                  노력했습니다. 이를 통해 환경측정분석 분야에 대한 전문성을
                  꾸준히 강화해왔으며, 정확하고 신뢰도 높은 데이터를 생산하는
                  분석가로 성장해왔습니다.
                </p>
              </section>
            </div>
            ...
            <div className="mt-10 grid gap-10 md:grid-cols-5">
              ...
              <section className="md:col-span-3 space-y-4">
                <p className="text-[12px] leading-7 text-zinc-800 mb-20">
                  저는 환경분석이 단순한 분석 업무가 아니라, 환경 관리의 기준이
